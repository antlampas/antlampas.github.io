...
- **Test unitari:** Si trovano in `tests/unit/`. Ogni modulo ha un file di test corrispondente. Esegui tutti i test con:
  ```python -m unittest discover tests/unit```
  Oppure esegui singoli test come in CI (`.github/workflows/unitTests.yml`).
